...
class WebSocketMessageWriter {
  ...
  pushString(val)
  {
      var utf8_array = Utf8.encode(val);
  ...
  pushTypedValue(value, type)
  {
      ...
      switch (type_byte) {
          ...
          case 0x14: {
              ...
              var expected_length = value.resolution_x * value.resolution_y * WebSocketMessageWriter.bytes_per_component[value.pixel_format] * WebSocketMessageWriter.components_per_pixel[value.pixel_format];
