...
```html
<script src='https://unpkg.com/@migenius/realityserver-client@1.0.9'></script>
```
or unminified
```html
<script src='https://unpkg.com/@migenius/realityserver-client@1.0.9/lib/umd/realityserver.js'></script> 
```
