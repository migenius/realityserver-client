...
```html
<script src='https://unpkg.com/@migenius/realityserver-client@1.0.4'></script>
```
or unminified
```html
<script src='https://unpkg.com/@migenius/realityserver-client/1.0.4/lib/umd/realityserver.js'></script> 
```
